...
void left_sweep() {
  ...
  pros::delay(1500);
  trapdoor.set(false);
  chassis.pid_odom_set({{-16, 16, 0}, fwd, DS});
  chassis.pid_wait_quick_chain();
...
void right_sweep() {
  ...
  chassis.pid_odom_set(5, DS);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set({{23, 10, -45}, fwd, DS});
  intakeUS.move(127);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set({{18, 14, 180}, fwd, DS});
  chassis.pid_wait_quick_chain();
...
void skills() {
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(ez::RIGHT_SWING, 0, -127, 1);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(-7, DS);
  intakeUS.move(127);
  pros::delay(2000);
  ...
  chassis.pid_odom_set(5, DS);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set({{-22, 63, 135}, fwd, 70});
  intakeUS.move(-127);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_odom_set(-5, DS);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set({{ 33, 64, 90}, fwd, 70});
  intakeLS.move(127);
  intakeUS.move(-127);
  chassis.pid_wait_quick_chain();
  matchload.set(true);
  ...
  chassis.pid_wait_quick_chain();
  trapdoor.set(false);
  chassis.pid_odom_set({{44, 96, 0}, fwd, DS});
  chassis.pid_wait_quick_chain();
  pros::delay(1000);
  chassis.pid_odom_set(-10, 127);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_odom_set(-45, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(ez::RIGHT_SWING, 180, -127, 1);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(-7, DS);
  intakeUS.move(127);
  pros::delay(2000);
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set({{5, 10, 180}, fwd, DS});
  intakeLS.move(127);
  intakeUS.move(127);
  chassis.pid_wait_quick_chain();
  aligner.set(true);
