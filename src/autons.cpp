...
void default_constants() {
  // P, I, D, and Start I
  chassis.pid_drive_constants_set(15.0, 0.01, 100.0);         // Fwd/rev constants, used for odom and non odom motions
  chassis.pid_heading_constants_set(9.0, 0.0, 35.0);          // Holds the robot straight while going forward without odom
  ...
  chassis.pid_swing_exit_condition_set(50_ms, 3_deg, 250_ms, 7_deg, 500_ms, 500_ms);
  chassis.pid_drive_exit_condition_set(50_ms, 1_in, 250_ms, 3_in, 500_ms, 500_ms);
  chassis.pid_odom_turn_exit_condition_set(50_ms, 4_deg, 250_ms, 7_deg, 500_ms, 750_ms);
  chassis.pid_odom_drive_exit_condition_set(50_ms, 1_in, 250_ms, 3_in, 500_ms, 750_ms);
  ...
  chassis.slew_drive_constants_set(5_in, 60);
...
void test() {
  ...
  intakeLS.move(127);
  intakeUS.move(-20);
  chassis.pid_odom_set(28, 127, true);
  ...
  matchload.set(true);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, 175, 127, 50, ccw);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_wait_quick_chain();
  descore.set(false);
  chassis.pid_swing_set(LEFT_SWING, 15, 127, 20, cw);
  chassis.pid_wait_quick_chain();
}
...
void awp() {
  ...
  matchload.set(true);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, 175, 127, 52, ccw); //50-60
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(-5, 127);
  chassis.pid_wait_quick_chain();
  intakeUS.move(127);
...
void right_sweep() {
  ...
  pros::delay(600);
  intakeUS.move(0);
  chassis.pid_swing_set(LEFT_SWING, -85, 127, -127, cw);
  intakeUS.move(127);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(11, 127);
  matchload.set(true);
  chassis.pid_wait_quick_chain();
  intakeUS.move(-20);
...
void left_contest() {
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, 0, 110, 10, ccw);
  chassis.pid_wait_quick_chain();
  descore.set(false);
  chassis.pid_odom_set(15, 127);
  chassis.pid_wait_quick_chain();
...
void right_contest() {
  ...
  chassis.pid_turn_set(90, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, -5, 110, 10, ccw);
  chassis.pid_wait_quick_chain();
  descore.set(false);
  chassis.pid_odom_set(15, 127);
  chassis.pid_wait_quick_chain();
...
void skills() {
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, 180, -90, 0, cw);
  chassis.pid_wait_quick_chain();
  ...
  intakeLS.move(127);
  intakeUS.move(-127);
  chassis.pid_odom_set(3, 70);
  chassis.pid_wait_quick_chain();
  pros::delay(150);
  chassis.pid_odom_set(-6, DS/3);
  intakeLS.move(-10);
  ...
  chassis.pid_odom_set(-10, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, 180, -127, 50);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(-40, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, -90, -127, 20);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, 0, -110, -10);
  matchload.set(true);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(-10, 127);
  chassis.pid_wait_until(-3);
  ...
  chassis.pid_wait_quick_chain();
  pros::delay(1500);
  chassis.pid_swing_set(LEFT_SWING, 90, -110, 40); //end of center bottom goal pt1
  chassis.pid_wait_quick_chain();
  intakeUS.move(-127);
  intakeLS.move(127);
  chassis.pid_odom_set(50, 127);
  ...
  chassis.pid_odom_set(-10, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, 0, -127, 50);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(-40, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, 90, -127, 20);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, 180, -110, -10);
  matchload.set(true);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(-10, 127);
