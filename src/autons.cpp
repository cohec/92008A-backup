...
void default_constants() {
  ...
  chassis.pid_turn_constants_set(3.0, 0.05, 35.0, 3.0);     // Turn in place constants
  chassis.pid_swing_constants_set(6.0, 0.0, 65.0);           // Swing constants
  chassis.pid_odom_angular_constants_set(6.5, 0.0, 52.5);    // Angular control for odom motions
  chassis.pid_odom_boomerang_constants_set(5.8, 0.0, 32.5);  // Angular control for boomerang motions

  // Exit conditions
  chassis.pid_turn_exit_condition_set(50_ms, 4_deg, 100_ms, 7_deg, 500_ms, 500_ms);
  chassis.pid_swing_exit_condition_set(50_ms, 3_deg, 100_ms, 7_deg, 500_ms, 500_ms);
  chassis.pid_drive_exit_condition_set(50_ms, 1.5_in, 100_ms, 3_in, 500_ms, 500_ms);
  chassis.pid_odom_turn_exit_condition_set(30_ms, 4_deg, 100_ms, 7_deg, 500_ms, 750_ms);
  chassis.pid_odom_drive_exit_condition_set(30_ms, 2_in, 100_ms, 3_in, 500_ms, 750_ms);
