...
void auto_wp_left() {
  ...
  chassis.pid_odom_set(5, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(ez::RIGHT_SWING, 90, 100, -50, ccw);
  intakeUS.move(127);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(50, DS);
  intakeUS.move(-127);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(ez::LEFT_SWING, -45, -90, -30);
  chassis.pid_wait_quick_chain();
...
void auto_wp_right() {
  ...
  pros::delay(900);
  intakeUS.move(0);
  chassis.pid_swing_set(ez::LEFT_SWING, -90, 40, -127, cw);
  chassis.pid_wait_quick_chain();
  intakeUS.move(127);
  ...
  matchload.set(true);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(ez::RIGHT_SWING, -120, 127, 50, ccw);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(15, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(ez::LEFT_SWING, 180, -127, -100, ccw);
  chassis.pid_wait_quick_chain();
  intakeUS.move(127);
  pros::delay(1200);
  chassis.pid_odom_set(20, 127);
