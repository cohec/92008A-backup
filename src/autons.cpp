...
void auto_wp_left() {
  ...
  chassis.pid_odom_set({{-8, 28}, fwd, 127});
  intakeUS.move(-127);
  intakeLS.move(127);
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, 90, 127, -20, ccw);
  intakeUS.move(127);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(35, DS);
  intakeUS.move(127);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(RIGHT_SWING, -45, 80, -20, ccw);
  chassis.pid_wait_quick_chain();
...
void auto_wp_right() {
  ...
  chassis.pid_odom_set(5, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set({{5, 27, -60}, fwd, 80});
  intakeUS.move(127);
  chassis.pid_wait_quick_chain();
  intakeUS.move(-127);
  ...
  pros::delay(1500);
  trapdoor.set(false);
  chassis.pid_odom_set(45.5, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_turn_set(-180, TS);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(14, 60);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(-25, 127, true);
  chassis.pid_wait_until(-6);
  matchload.set(false);
...
void left_sweep() {
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(-26, DS, true);
  chassis.pid_wait_until(-6);
  matchload.set(false);
  chassis.pid_wait_quick_chain();
  intakeUS.move(127);
  ...
  chassis.pid_wait_quick_chain();
  intakeUS.move(127);
  chassis.pid_odom_set({{-13, 23, 45}, fwd, DS});
  chassis.pid_wait_quick_chain();
  intakeUS.move(-127);
  ...
  pros::delay(1000);
  trapdoor.set(false);
  chassis.pid_odom_set({{-17, 15, 0}, fwd, DS});
  chassis.pid_wait_quick_chain();
...
void right_sweep() {
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set({{17, 14, 180}, fwd, DS});
  chassis.pid_wait_quick_chain();
...
void skills() {
  ...
  pros::delay(2000);
  intakeUS.move(0);
  chassis.pid_odom_set(15, DS/1.5);
  matchload.set(true);
  intakeUS.move(-127);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(11, DS/3);
  chassis.pid_wait_quick_chain();
  pros::delay(1500);
  chassis.pid_odom_set(-24.5, DS, true);
  chassis.pid_wait_until(-6);
  matchload.set(false);
  chassis.pid_wait_quick_chain();
  intakeUS.move(127);
  ...
  chassis.pid_odom_set(5, DS);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set({{-18, 63, 135}, fwd, 60});
  intakeUS.move(-127);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(7, DS/3);
  chassis.pid_wait_quick_chain();
  pros::delay(300);
  intakeLS.move(-80);
  pros::delay(2000);
  chassis.pid_odom_set(-5, DS);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set({{ 35, 65, 90}, fwd, 60});
  intakeLS.move(127);
  intakeUS.move(-127);
  chassis.pid_wait_quick_chain();
  matchload.set(true);
  ...
  chassis.pid_wait_quick_chain();
  trapdoor.set(false);
  chassis.pid_odom_set({{47, 100, 0}, fwd, DS});
  chassis.pid_wait_quick_chain();
  pros::delay(1000);
  chassis.pid_odom_set(-10, 127);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_odom_set(5, DS);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set({{24, 24, -45}, fwd, DS});
  intakeUS.move(127);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(9, DS/2);
  intakeUS.move(-127);
