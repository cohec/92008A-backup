...
void default_constants() {
  ...
  chassis.pid_drive_exit_condition_set(50_ms, 2_in, 150_ms, 3_in, 500_ms, 500_ms);
  chassis.pid_odom_turn_exit_condition_set(50_ms, 4_deg, 150_ms, 7_deg, 500_ms, 750_ms);
  chassis.pid_odom_drive_exit_condition_set(50_ms, 2_in, 150_ms, 3_in, 500_ms, 750_ms);
