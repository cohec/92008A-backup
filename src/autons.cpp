...
void auto_wp_right() {
  ...
  pros::delay(700);
  intakeUS.move(0);
  chassis.pid_swing_set(ez::LEFT_SWING, -88, 60, -127, cw);
  intakeUS.move(127);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_wait_quick_chain();
  descore.set(false);
  chassis.pid_swing_set(ez::LEFT_SWING, 15, 127, 20, cw);
  chassis.pid_wait_quick_chain();
}
...
void right_sweep() {
  ...
  matchload.set(true);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(ez::RIGHT_SWING, -45, -120, 50, cw);
  chassis.pid_wait_quick_chain();
  matchload.set(false);
  chassis.pid_odom_set(15, 127);
  chassis.pid_wait_until(10);
...
void left_contest() {
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(ez::RIGHT_SWING, -10, 100, 10, ccw);
  chassis.pid_wait_quick_chain();
  descore.set(false);
  chassis.pid_odom_set(15, 127);
  chassis.pid_wait_quick_chain();
...
void right_contest() {
  ...
  matchload.set(true);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(ez::LEFT_SWING, 180, -100, 20, ccw);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(15, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set(10, DS/1.5);
  ...
  chassis.pid_turn_set(90, 127);
  chassis.pid_wait_quick_chain();
  chassis.pid_swing_set(ez::RIGHT_SWING, -15, 100, 10, ccw);
  chassis.pid_wait_quick_chain();
  descore.set(false);
  chassis.pid_odom_set(15, 127);
  chassis.pid_wait_quick_chain();
