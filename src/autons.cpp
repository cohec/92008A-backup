...
void default_constants() {
  ...
  chassis.pid_heading_constants_set(8.0, 0.0, 35.0);        // Holds the robot straight while going forward without odom
  ...
  chassis.pid_drive_exit_condition_set(50_ms, 1.5_in, 250_ms, 3_in, 500_ms, 500_ms);
  chassis.pid_odom_turn_exit_condition_set(50_ms, 4_deg, 250_ms, 7_deg, 500_ms, 750_ms);
  chassis.pid_odom_drive_exit_condition_set(50_ms, 1.5_in, 250_ms, 3_in, 500_ms, 750_ms);
...
void auto_wp_left() {
  ...
  chassis.pid_odom_set(5, DS);
  chassis.pid_wait_quick_chain();
  chassis.pid_odom_set({{50, 30, 90}, fwd, DS});
  intakeLS.move(127);
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set(-5, DS/2);
  chassis.pid_wait_quick_chain();
...
void left_sweep() {
  ...
  chassis.pid_wait_quick_chain();
  intakeUS.move(127);
  chassis.pid_odom_set({{-16, 16, 45}, fwd, DS});
  chassis.pid_wait_quick_chain();
  intakeUS.move(-127);
  chassis.pid_odom_set(23, DS/2);
  chassis.pid_wait_quick_chain();
